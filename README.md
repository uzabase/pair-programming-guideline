...
　仮にA、B、Cというステップ（この場合、ABCがそろって初めて1つの意味になるとする）があった場合に自分はA \-\> B \-\> Cの順番でタイピングするが、相手によってはB \-\> C \-\> Aの順番でタイピングをしようと考えているかもしれない。その場合にBをタイピングし始めた時に「Aを書かないとダメだよ」というコミュニケーションは控える方が望ましい。相手のリズムや思考を邪魔してしまう可能性があるからだ。議論・提案・指摘等は、一旦相手のタイピングが一区切りしてから行うことでお互いがスムーズに気持ちよくペアプロを進めることが出来るようになるだろう。  
